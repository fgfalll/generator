...
class DocumentGeneratorApp(QMainWindow):
    ...
    def select_score_columns(self):
        ...
        try:
            ...
            if dialog.exec_() == QDialog.Accepted:
                ...
                QMessageBox.information(self, "Score Columns Selected",
                                        f"Selected score columns: {', '.join(self.selected_score_columns)}")
        except Exception as e:
            QMessageBox.critical(self, "Error", f"An error occurred while reading Excel file: {e}")
    ...
    def create_documents(self, df, what):
        try:
            ...
            QMessageBox.critical(self, "Error", f"An error occurred while creating documents: {e}")
